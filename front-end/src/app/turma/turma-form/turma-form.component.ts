...
export class TurmaFormComponent implements OnInit {
  ...
  constructor(
    ...
    private cursoSvr: CursoService,
    private professorSvr: ProfessorService,
    private salaAulaSvr: SalaAulaService
  ...
  async ngOnInit() {
    ...
    async carregarDados () {
        try {
            this.cursos = await this.cursoSvr.listar()
            this.professores = await this.professorSvr.listar()
            this.salasAula = await this.salaAulaSvr.listar()
        }
        catch(erro) {
            console.log(erro)
